...
type ReadyBalanceInsightsProps = {
  totalIncome?: number;
  readyAmount?: number;
  totalCosts?: number;
...
export default function ReadyBalanceInsights({
  totalIncome = 6000,
  readyAmount = 5400,
  totalCosts = 600,
  deliveredCount = 5,
  canceledCount = 2,
}: ReadyBalanceInsightsProps) {
  const { t } = useTranslation();

  const totalStat = {
    key: "total",
    value: `${totalIncome} DA`,
    label: t("ready_balance_insights.total_income"),
  ...
  const balanceStats = [
    {
      key: "ready",
      value: `${readyAmount} DA`,
      label: t("ready_balance_insights.ready_amount"),
    ...
    },
    {
      key: "costs",
      value: `${totalCosts} DA`,
      label: t("ready_balance_insights.total_costs"),
    ...
    },
    {
      ...
      label: t("ready_balance_insights.delivered"),
    ...
    },
    {
      key: "canceled",
      value: canceledCount,
      label: t("ready_balance_insights.canceled"),
